...
public class DmsException extends OntimizeJEEException {
	 ...
	 *            the silent
	 */
	public DmsException(String message, Object[] msgParameters, Throwable cause, MessageType msgType, boolean msgBlocking, boolean silent) {
	 ...
	 *            the writable stack trace
	 */
	public DmsException(String message, Throwable cause, MessageType msgType, boolean msgBlocking, boolean silent, boolean enableSuppression, boolean writableStackTrace) {
